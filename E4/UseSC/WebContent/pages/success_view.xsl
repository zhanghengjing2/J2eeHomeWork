        ...
        <html>
            ...
            <body>
                <form>
                    ...
                    <label>
                        <xsl:attribute name="name"><xsl:value-of select="/view/body/form/textView[1]/name"/></xsl:attribute>
                        <xsl:value-of select="/view/body/form/textView[1]/label"/>
                    </label>
                    
                    <label>
                    	<xsl:value-of select="/view/body/form/textView[1]/value"/>
                    </label><br/>
                    
                    <label>
                        <xsl:attribute name="name"><xsl:value-of select="/view/body/form/textView[2]/name"/></xsl:attribute>
                        <xsl:value-of select="/view/body/form/textView[2]/label"/>
                    </label>
                    
                    <label>
                    	<xsl:value-of select="/view/body/form/textView[2]/value"/>
                    </label><br/>
